...
<form id ="uploadForm">
<div id="imgDiv"></div>
<img id="showImg" width="100" height="100"> <!-- 카메라 아이콘을 통해서 선택한 이미지가 맞는지 확인하기 위해서 이미지를 보이게 한다. -->
<img id ="camera" src="../img/img3.gif" width="50" height="50" alt="카메라">
<input type="file" name="img" id="img">
<br><br>
<input type="button" id="uploadBtn" value="이미지 등록"> <!-- 업로드 하기 위해 -->
<script type="text/javascript" src="http://code.jquery.com/jquery-3.6.1.min.js"></script>
...
//업로드 버튼을 누르기 전에 카메라 아이콘을 통해서 선택한 이미지가 나오게 
